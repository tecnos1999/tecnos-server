...
public class Utils {
    ...
    public static final String[] PUBLIC_URLS = {"/swagger-ui.html","/swagger-ui/**","/v3/**","/server/api/v1/login","/server/api/v1/register" , "/server/api/v1/category/*" ,"/server/api/v1/subcategory/*"};
}
